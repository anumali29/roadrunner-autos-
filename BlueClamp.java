...
@Autonomous
public class BlueClamp extends LinearOpMode{
    public class Lift(){
    ...
    Action setClawPosition(double position) {
        ...
        //grabs from ground
        Action grab2 = drive.actionBuilder(new Pose2d(-10, 36, Math.toRadians(270)))
                .lineToY(45)
